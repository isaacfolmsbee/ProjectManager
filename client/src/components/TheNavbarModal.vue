<template>
<div class="fixed top-16 w-full h-full flex flex-col items-center bg-primary-400">	
...
.router-link {
	@apply py-2 px-3 text-2xl text-gray-light-50;
}

.router-link-exact-active {
	@apply font-bold bg-gray-dark-400 shadow-md rounded-lg;
}
</style>